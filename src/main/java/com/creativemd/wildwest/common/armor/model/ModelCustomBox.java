...
public class ModelCustomBox extends ModelBox
{
    ...
    public ModelCustomBox(ModelRenderer p_i1171_1_, int p_i1171_2_, int p_i1171_3_, float p_i1171_4_, float p_i1171_5_, float p_i1171_6_, int p_i1171_7_, int p_i1171_8_, int p_i1171_9_, float p_i1171_10_, int resolution)
    {
        ...
        p_i1171_7_ *= resolution;
        p_i1171_8_ *= resolution;
        p_i1171_9_ *= resolution;
